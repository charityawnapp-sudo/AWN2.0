    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (loggedIn) {
        ...
        if (isBiometricSupported) {
          try {
            _model.biometricsSupported = await localAuth.authenticate(
                localizedReason: 'Checked for Biometric Support');
          } on PlatformException {
            _model.biometricsSupported = false;
          }
          safeSetState(() {});
        }

        if (_model.biometricsSupported == true) {
          if (!mounted) return;
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.formKey.currentState == null ||
                                ...
                                safeSetState(() => _model.checked = false);
                                return;
                              }
                              ...
                              if (_model.checked == true) {
                                context.goNamedAuth(HomeScreenWidget.routeName,
                                    context.mounted);
                              } else {

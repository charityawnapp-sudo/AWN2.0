...
import 'loginfalied_model.dart';
export 'loginfalied_model.dart';
...
class LoginfaliedWidget extends StatefulWidget {
  const LoginfaliedWidget({super.key});

  @override
  State<LoginfaliedWidget> createState() => _LoginfaliedWidgetState();
}

class _LoginfaliedWidgetState extends State<LoginfaliedWidget> {
  late LoginfaliedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginfaliedModel());

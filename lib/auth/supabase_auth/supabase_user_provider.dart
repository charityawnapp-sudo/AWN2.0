...
class Awn1SupabaseUser extends BaseAuthUser {
  Awn1SupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> awn1SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = Awn1SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
